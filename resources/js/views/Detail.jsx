        ...
        <div>
            {
                ...
                group !== null &&
                    <div className="bg-gradient-to-r from-orange-300 to-orange-800 text-white p-5 rounded-lg relative mt-16">
                        ...
                        <p className="text-sm text-orange-100 flex items-center">{users[0].name}, { users.length > 1 && users[1].name } { users.length > 2 ? `dan ${users.length - 2} lainnya` : ''}</p>
            ...
            <BtnAddPost code={code} getPosts={getPosts} />
